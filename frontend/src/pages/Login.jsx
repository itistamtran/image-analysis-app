...
export default function LoginPage() {
  ...
  const normalizeUser = (data) => {
    ...
    return {
      ...userData,
      verification_status:
        userData.verification_status || userData.verificationStatus,
    };
  };
      ...
      <div className="flex items-center justify-center flex-1">
        <div className="w-[85%] md:w-[35%] bg-gradient-to-br from-cyan-500/30 to-blue-700/30 backdrop-blur-md p-6 rounded-xl ">
          <form onSubmit={handleLogin} className="space-y-6">
            <h2 className="mb-6 text-2xl font-bold tracking-wider text-center text-white font-neue-machina-bold">
              Login
            </h2>

            {/* Show redirect message if exists */}
            {message && (
              <p className="mt-4 mb-6 text-sm tracking-wider text-center cursor-pointer text-cyan-400 font-neue-machina">
                {message}
              </p>
            )}
            ...
            <div className="flex justify-center">
              <button
                ...
                style={{
                  ...
                  backgroundImage: `linear-gradient(rgba(15, 23, 42, ${
                    hover ? 1 : 0.6
                  }), rgba(15, 23, 42, ${
                    hover ? 1 : 0.6
              ...
              >
                ...
                <img
                  src="/Google_2015_logo.webp"
                  alt="Google"
                  className="h-5 ml-2 w-18"
                />
              </button>
            </div>
            ...
            <div className="flex items-center my-4">
              ...
              <span className="mx-2 text-sm text-gray-400 font-neue-machina">
                OR
              </span>
              <hr className="flex-grow border-cyan-600" />
            </div>
                ...
                className={`flex items-center justify-center gap-2 px-6 py-2 text-sm font-bold tracking-wider text-white transition duration-200 rounded-md bg-transparent 
                                    ${
                                      loading
                                        ...
                                        : "hover:shadow-[0_0_12px_rgba(0,255,255,0.4)]"
                                    }`}
                style={{
                  border: "2px solid transparent",
                  backgroundImage:
                    "linear-gradient(#0f172a, #0f172a), linear-gradient(to right, #5de0e6, #004aad)",
                  backgroundOrigin: "border-box",
                  backgroundClip: "padding-box, border-box",
                  fontFamily: "Neue Machina Bold, sans-serif",
                  letterSpacing: "0.15em",
